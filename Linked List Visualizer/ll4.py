...
#CONSTANTS
RADIUS, LINE_WIDTH, OPACITY, START_COORD, LOOPED = 0.3, 3, 0.3, -6, 1
...
L1 = LinkedList([1, 2, 3, 4, 5, 6, 7, 8, 9])
L2 = LinkedList([5,6,7,8], 2.5)
LL =[L1]
L1.array[-1].next = L1.array[3]

def function(L1:LinkedList) -> list:
    ptr1, ptr2 = L1.head, L1.head.next
    res1 = []
    res2 = []
    while ptr1 != ptr2:
        res1.append(ptr1)
